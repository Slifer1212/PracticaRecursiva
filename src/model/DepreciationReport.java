...
public final class DepreciationReport {
    ...
    /**
     * The number of years over which the depreciation is calculated for this report.
     * This value determines the duration of the depreciation period and corresponds to
     * the number of depreciation records that should be included in the report.
     */
